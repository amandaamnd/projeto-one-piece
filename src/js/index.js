...
marcar o botão como selecionado e mostrar o personagem correspondente
    ...
    OBJETIVO 1 - quando clicar no botão do personagem na lista, marcar o botao como selecionado
        passo 1 - pegar os botões ma de um deles
        passo 2 - adicionar a classe "selecionado" no botão que o usuário clicou
        passo 3 - verificar se já existe um botão selecionado, se sim, devemos removerno JS pra poder verificar quando o usuário clicar em ci
a seleção dele
